  ...
  return (
    <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)} className='flex-1'>
      <Tilt
        ...
        className='h-full flex flex-col justify-between from-[#6C63FF]/10 via-[#7F7FFF]/20 to-[#5F5FFF]/10 border border-[#6C63FF]/20 hover:shadow-[#6C63FF]/30 p-5 rounded-2xl sm:w-[360px] w-full shadow-md transition-all duration-300'
      >
